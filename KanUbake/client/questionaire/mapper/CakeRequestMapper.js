    ...
    static toApiPayload(cakeRequest) {
        ...
        return {
            ...
            requestData: {
                ...
                tierFlavors: cakeRequest.tierFlavors.map((tierFlavor) => ({ ...tierFlavor })),
                ...
                chocolateGlazeOtherPreserveFlavor: cakeRequest.chocolateGlazeOtherPreserveFlavor,

                fondantLayer: cakeRequest.fondantLayer,
                fondantLayerDetails: cakeRequest.fondantLayerDetails.map((detail) => ({ ...detail })),
                ...
                paletteBaseColor: cakeRequest.paletteBaseColor ? { ...cakeRequest.paletteBaseColor } : null,
                ...
                textDetails: cakeRequest.textDetails ? { ...cakeRequest.textDetails } : null,
